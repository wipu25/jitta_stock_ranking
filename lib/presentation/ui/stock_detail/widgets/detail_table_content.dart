        ...
        return Column(
          ...
          children: [
            ...
            if(dataList[tableState].title != null)
              Row(
                children: [
                  Text(dataList[tableState].title!, style: CustomTextStyle.itemHeading1,),
                  const SizedBox(width: 8),
                  if(dataList[tableState].type == 'good')
                    Icon(Icons.thumb_up, size: 16, color: JittaColors.primaryColor,)
                ],
              ),
            if(dataList[tableState].value != null)
              Padding(
                padding: const EdgeInsets.all(2.0),
                child: Text('${Strings.remarkStar}${dataList[tableState].value}', style: CustomTextStyle.remarkContent1,),
              ),
            dataList[tableState].display?.columnHead !=
                null ? Center(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: DataTable(
                      ...
                      headingRowColor: WidgetStateProperty. resolveWith<Color?>((Set<WidgetState> states) {
                        return JittaColors.primaryColor;  // Use the default value.
                      }),
                      columns: [
              ...
              height: 200,
              child: Center(child: Text(Strings.noDataFound, style: CustomTextStyle.itemHeading1.copyWith(color: JittaColors.stateGreyColor),)),
            )
          ],
        );
      }),
